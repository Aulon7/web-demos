...
sr.reveal('.home-reviews, .contact-content', {origin: 'bottom', duration: 2500, delay: 300});
sr.reveal('#logo', {origin: 'bottom', delay: 100})
sr.reveal('.footer-content');
sr.reveal('.footer-card ul li, .cards-container', {distance: '150px', origin: 'right'});
...
sr.reveal('.residencies-container, .value-content', {origin: 'bottom', duration: 2500, delay: 300});
