...
const myChart1 = new Chart(ctx, {
  ...
  data: {
      ...
      data: [688, 690, 689, 689, 686, 687, 689, 689, 690, 694, 695, 699, 701,705, 706, 713, 716],
    }]
...
let myChart2 = new Chart(ctx2, {
  type: 'pie',
  data: {
  labels: ["Payment History","Amounts owed","Length of credit history", "Credit mix","New credit"],
    datasets: data
  },
  options: options,
...
let myChart3 = new Chart(ctx3, {
  type: 'bar',
  data: {
    labels: ["Age 18 to 23", "Age 24 to 39", "Age 40 to 55", "Age 56 to 74", "Age 75+"],
    datasets: [{
